...
instructions = sprintf([...
    ...
    '2. Remove the old version (if exists):\n' ...
    '       - In MATLAB, run: rmpath(genpath(''%s'')); savepath;\n' ...
    '       - Or delete the old folder directly (backup recommended).\n' ...
    '3. Navigate to the root directory of the extracted new version (which should contain the SNBPI folder and setup_path.m).\n' ...
    '4. Run the setup_path script in MATLAB:\n' ...
    '       >> setup_path\n' ...
    '   This script will automatically add all non-package folders (excluding those starting with ''+'') under SNBPI to the MATLAB path and save it permanently.\n' ...
    '5. Restart SNBPI.\n\n' ...
    'Note: Please close SNBPI before updating.'], oldPath);
