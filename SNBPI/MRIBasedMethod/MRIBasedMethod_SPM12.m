function MRIBasedMethod_SPM12(MRInames,PETnames,bbox,...
...
% =========================================================================
    ...
    matlabbatch{2}.spm.spatial.preproc.tissue(1).tpm = {fullfile(filepath,'TPM','TPM_Gray.nii')};
    ...
    matlabbatch{2}.spm.spatial.preproc.tissue(2).tpm = {fullfile(filepath,'TPM','TPM_White.nii')};
    ...
    matlabbatch{2}.spm.spatial.preproc.tissue(3).tpm = {fullfile(filepath,'TPM','TPM_CSF.nii')};
    matlabbatch{2}.spm.spatial.preproc.tissue(3).ngaus = 2;
    matlabbatch{2}.spm.spatial.preproc.tissue(3).native = [0 0];
    matlabbatch{2}.spm.spatial.preproc.tissue(3).warped = [0 0];
    matlabbatch{2}.spm.spatial.preproc.tissue(4).tpm = {fullfile(filepath,'TPM','TPM_Bone.nii')};
    matlabbatch{2}.spm.spatial.preproc.tissue(4).ngaus = 3;
    matlabbatch{2}.spm.spatial.preproc.tissue(4).native = [0 0];
    matlabbatch{2}.spm.spatial.preproc.tissue(4).warped = [0 0];
    matlabbatch{2}.spm.spatial.preproc.tissue(5).tpm = {fullfile(filepath,'TPM','TPM_Skin.nii')};
    matlabbatch{2}.spm.spatial.preproc.tissue(5).ngaus = 4;
    matlabbatch{2}.spm.spatial.preproc.tissue(5).native = [0 0];
    matlabbatch{2}.spm.spatial.preproc.tissue(5).warped = [0 0];
    matlabbatch{2}.spm.spatial.preproc.tissue(6).tpm = {fullfile(filepath,'TPM','TPM_Background.nii')};
