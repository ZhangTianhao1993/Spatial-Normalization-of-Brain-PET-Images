...
% See also: rov.ui.recreateImageGrid, rov.render.renderPage
    ...
    s.h.btnPageUp = uibutton(bg, 'push', 'Text', [C.glyph.pageUp ' Page Up'], ...
        'BackgroundColor', C.scrollbtn, 'FontColor', C.text, ...
        'ButtonPushedFcn', @(~,~) rov.callbacks.onPageUp(fig));
    s.h.btnStepUp = uibutton(bg, 'push', 'Text', [C.glyph.stepUp ' Step Up'], ...
        'BackgroundColor', C.scrollbtn, 'FontColor', C.text, ...
    ...
    s.h.btnStepDown = uibutton(bg, 'push', 'Text', [C.glyph.stepDown ' Step Down'], ...
        'BackgroundColor', C.scrollbtn, 'FontColor', C.text, ...
        'ButtonPushedFcn', @(~,~) rov.callbacks.onStepDown(fig));
    s.h.btnPageDown = uibutton(bg, 'push', 'Text', [C.glyph.pageDown ' Page Down'], ...
        'BackgroundColor', C.scrollbtn, 'FontColor', C.text, ...
